...
/*FADE NAVBAR DROPDOWN ON HOVER*/
$(document).ready(function () {
  $('.menu-toggle').hover(function () {
    $('nav').toggleClass('active');
  });

  $('ul.hover > li:first-child').on('mouseenter', function () {
    $(this).find('.dropdown').fadeIn(300);
  });

  $('ul.hover > li:first-child').on('mouseleave', function () {
    $(this).find('.dropdown').fadeOut(300);
  });
});


/*MOVE NAVBAR UP ON SCROLL*/
...
const activeLinks = document.querySelectorAll("ul.hover a.active, div.hover a.active");
